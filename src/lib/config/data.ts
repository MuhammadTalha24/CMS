export const data = {
	...
	hero: {
		...
		two: {
			...
			textlist: [
				...
				'Development: Provides software tools, automated systems, and bots to help accelerate repetitive tasks.',
				'Implementation: Helps automate repeatable, data-driven processes that are currently done manually.',
				'Assessment: Helps determine if a process is eligible for RPA implementation.',
				'Process mining: Helps determine which processes to automate based on volume, repetitiveness, and ROI.',
				'Support and maintenance: Includes bot maintenance, monitoring, health checks, and release management.',
			],
		},
		three: {
	...
	contact: {
		title: 'Contact Us',
		shortDescription:
			"We'd love to hear from you! Whether you have a question about our services, need support, or are interested in partnering with us, our team is here to assist you.",
		touch: {
			title: 'Get in Touch',
			emai: [
				{
					boldText: 'General Inquiries:',
					mail: 'info@technoveltysolutions.com',
				},

				{
					boldText: 'Careers:',
					mail: 'career@technoveltysolutions.com',
				},
				{
					boldText: 'Support:',
					mail: 'support@technoveltysolutions.com',
				},
			],
			phone: {
				title: 'Phone',
			...
			address: {
				...
				officeName: 'Tech Novelty Limited',
